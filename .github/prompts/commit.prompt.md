---
description: "scafctl-plugin-auth-entra: Generate a conventional commit message from staged or recent changes. Outputs the message only -- does not run git commit."
